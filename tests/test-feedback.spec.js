...
//   await page.getByRole('textbox', { name: 'Input Password' }).fill('210746_Ttt');
//   await page.getByRole('button', { name: 'เข้าสู่ระบบ' }).click();
//   await page.locator('select[name="date"]').selectOption('2025-03-07');
//   await page.locator('div').filter({ hasText: 'หฟดฟหกดฟโดย Kriengkai' }).nth(3).click();
//   const targetDiv = await page.locator('div').filter({ hasText: 'หฟดฟหกดฟโดย Kriengkai' }).nth(3);
...
//   await page.getByRole('textbox', { name: 'Input Password' }).fill('210746_Ttt');
//   await page.getByRole('button', { name: 'เข้าสู่ระบบ' }).click();
//   await page.locator('select[name="type"]').selectOption('กดก');
//   await page.locator('div').filter({ hasText: 'หฟดฟหกดฟโดย Kriengkai' }).nth(3).click();
//   const targetDiv = await page.locator('div').filter({ hasText: 'หฟดฟหกดฟโดย Kriengkai' }).nth(3);
